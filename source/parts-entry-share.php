<div class="entry-share">
  ...
  <div class="share-button share-twitter">
    <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php the_permalink(); ?>" data-text~"<?php wp_title('/', true, 'right'); bloginfo('name'); ?>" data-via="ryo_dg" data-lang="ja" data-related="ryo_dg">ツイート</a>
  </div>
</div>