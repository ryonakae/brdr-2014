...
return f=f.replace(/(?:%\w{2})+/g,function(f){return b.match(f.toLowerCase())||f})},trim:function(b){if(String.prototype.trim)b=String(b).trim();else if(b=String(b).replace(/^[\s\uFEFF\xA0]+/,""))for(var f=b.length;--f;)if(/[^\s\uFEFF\xA0]/.test(b.charAt(f))){b=b.substring(0,f+1);break}return b},fire:function(b,f,h,k){return"function"===typeof b?k?setTimeout(function(){b.apply(f,h)},0):b.apply(f,h):b},hashscroll:function(b){var f=k.settings[1].destination.hash.slice(1);return!(b||!f)&&l("#"+(f?f:
", [name~="+f+"]")).first().each(function(){isFinite(l(this).offset().top)&&n.scrollTo(l(n).scrollLeft(),parseInt(Number(l(this).offset().top),10))}).length},wait:function(b){var f=l.Deferred();if(!b)return f.resolve();setTimeout(function(){f.resolve()},b);return f.promise()},fallback:function(b){switch(b.type.toLowerCase()){case "click":n.location.href=b.currentTarget.href;break;case "submit":b.target.submit();break;case "popstate":n.location.reload()}},find:function(b,f){var h=[];b.replace(f,function(b,
d){h.push(d)});return h},scope:function(b,f,h,m){var d,a,g,c,n,p,w,t,B,s,u,q,v;d=[].slice.call(arguments);d.splice(1,1,f||b.location.href);d.splice(2,1,h||b.destination.href);a=b.scope;f=(f||b.location.href).replace(/.+?\w(\/[^#?]*).*/,"$1");h=(h||b.destination.href).replace(/.+?\w(\/[^#?]*).*/,"$1");g=f.replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");n=(m||f).replace(/^\//,"").replace(/([?#])/g,"/$1").split("/");if(m){if(!~m.indexOf("*"))return z;c=[];for(var x=0,y=n.length;x<y;x++)"*"===n[x]&&
c.push(g[x])}for(x=n.length+1;x--;)if(B=s=u=q=z,g=n.slice(0,x).join("/").replace(/\/([?#])/g,"$1"),(g="/"+g+("/"===(m||f).charAt(g.length+1)?"/":""))&&g in a){if(!a[g]||!a[g].length)return!1;for(var D=0;(p=a[g][D])&&!1!==u&&!1!==q;D++)if("rewrite"!==p||"function"!==typeof a.rewrite||m)if("inherit"===p)s=!0;else if("string"===typeof p){p=(w="^"===p.charAt(0))?p.slice(1):p;p=(t="*"===p.charAt(0))?p.slice(1):p;if(m&&~p.indexOf("/*/"))for(var F=0,y=c.length;F<y;F++)p=p.replace("/*/","/"+c[F]+"/");if(!(!w&&
u||(t?f.search(p):f.indexOf(p)))){if(w)return!1;u=!0}if(!(!w&&q||(t?h.search(p):h.indexOf(p)))){if(w)return!1;q=!0}}else"object"===typeof p&&(v=p);else if(d.push(k.fire(a.rewrite,null,[h])),B=arguments.callee.apply(this,d)){u=q=!0;break}else if(!1===B)return!1;if(u&&q)return l.extend(!0,{},b,("object"===typeof B?B:v)||{});if(!s)break}},database:function(b){var f=k.settings[1],h,m,d,a,g,c;h=f.gns;m=1;d=Math.floor((new Date).getTime()/864E5);a=k.IDBFactory;g=k.IDBDatabase;b=b||0;f.database=!1;if(!a||
!h||5<b)return!1;try{var z=function(c){k.IDBDatabase=null;g&&g.close&&g.close();a.deleteDatabase(h);c?setTimeout(function(){k.database(++b)},c):k.database(++b)};m=parseInt(d-d%7+m,10);g=a.open(h);g.onblocked=function(){};g.onupgradeneeded=function(){var a=this.result;try{for(var b=a.objectStoreNames?a.objectStoreNames.length:0;b--;)a.deleteObjectStore(a.objectStoreNames[b]);a.createObjectStore(f.gns,{keyPath:"id",autoIncrement:!1}).createIndex("date","date",{unique:!1})}catch(c){}};g.onsuccess=function(){try{g=
this.result,k.IDBDatabase=g,(c=k.dbStore())?c.get("_version").onsuccess=function(){this.result&&m!==this.result.title?z():(k.dbVersion(m),k.dbCurrent(),k.dbTitle(f.location.href,D.title),k.dbScroll(l(n).scrollLeft(),l(n).scrollTop()),f.database=!0)}:z()}catch(a){z(1E3)}};g.onerror=function(a){z(1E3)}}catch(p){z(1E3)}},dbStore:function(){for(var b=k.settings[1],f=k.IDBDatabase,h=f&&f.objectStoreNames?f.objectStoreNames.length:0;h--;)if(b.gns===f.objectStoreNames[h])return f&&f.transaction&&f.transaction(b.gns,
"readwrite").objectStore(b.gns);return!1},dbCurrent:function(){var b=k.settings[1],f=k.dbStore();if(f){var h;h=k.canonicalizeURL(n.location.href);h=b.hashquery?h:h.replace(/#.*/,"");f.put({id:"_current",title:h})}},dbVersion:function(b){var f=k.dbStore();f&&f.put({id:"_version",title:b})},dbTitle:function(b,f){var h=k.settings[1],m=k.dbStore();m&&(b=h.hashquery?b:b.replace(/#.*/,""),f?m.get(b).onsuccess=function(){m.put(l.extend(!0,{},this.result||{},{id:b,title:f,date:(new Date).getTime()}));k.dbClean()}:
m.get(b).onsuccess=function(){this.result&&this.result.title&&(D.title=this.result.title)})},dbScroll:function(b,f){var h=k.settings[1],m=k.dbStore(),d=h.location.href,a=arguments.length;h.scroll.record&&m&&(d=h.hashquery?d:d.replace(/#.*/,""),m.get("_current").onsuccess=function(){this.result&&this.result.title&&d===this.result.title&&(a?m.get(d).onsuccess=function(){m.put(l.extend(!0,{},this.result||{},{scrollX:parseInt(Number(b),10),scrollY:parseInt(Number(f),10)}))}:m.get(d).onsuccess=function(){this.result&&
isFinite(this.result.scrollX)&&isFinite(this.result.scrollY)&&n.scrollTo(parseInt(Number(this.result.scrollX),10),parseInt(Number(this.result.scrollY),10))})})},dbClean:function(){var b=k.dbStore();b.count().onsuccess=function(){1E3<this.result&&(b.index("date").openCursor(k.IDBKeyRange.upperBound((new Date).getTime()-2592E5)).onsuccess=function(){var f=this.result;f?(f["delete"](f.value.id),f["continue"]()):b.count().onsuccess=function(){1E3<this.result&&b.clear()}})}}};(function(b,f,h,k,d){b.fn[d.name]=
b[d.name]=function(){return F.apply(this,[b,f,h,k,d].concat([].slice.call(arguments)))};d.setProperties.call(b[d.name])}).apply(this,[].slice.call(arguments).concat([k]))})(jQuery,window,document,void 0);