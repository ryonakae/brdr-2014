...
WP_HOSTNAME          = "brdr.local" # e.g example.com
WP_IP                = "192.168.33.15" # host ip address

WP_HOME              = "" # path to WP_HOME, e.g blank or /wp or ...
WP_SITEURL           = "/wordpress" # path to WP_SITEURL, e.g or /wp or ...

WP_TITLE             = "Border Local" # title
WP_ADMIN_USER        = "admin" # default user
WP_ADMIN_PASS        = "admin" # default user's password

WP_DB_PREFIX         = 'wp_' # Database prefix
WP_DB_HOST           = WP_IP # or WP_IP and other
...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "theme/border-2014/", "/var/www/wordpress/wordpress/wp-content/themes/border-2014", :create => "true"
