...
--
-- Host: 192.168.33.15    Database: wordpress
-- ------------------------------------------------------
...
INSERT INTO `wp_comments` VALUES (1,1,'Mr WordPress','','https://wordpress.org/','','2015-02-03 04:53:57','2015-02-03 04:53:57','これはコメントです。\nコメントを削除するには、ログインして投稿編集画面でコメントを表示してください。編集または削除するオプションが用意されています。',0,'1','','',0,0);
...
INSERT INTO `wp_posts` VALUES (1,1,'2015-02-03 04:53:57','2015-02-03 04:53:57','WordPress へようこそ。これは最初の投稿です。編集もしくは削除してブログを始めてください !','Hello world!','','publish','open','open','','hello-world','','','2015-02-03 04:53:57','2015-02-03 04:53:57','',0,'http://brdr.local/?p=1',0,'post','',1),(2,1,'2015-02-03 04:53:57','2015-02-03 04:53:57','これはサンプルページです。同じ位置に固定され、(多くのテーマでは) サイトナビゲーションメニューに含まれるため、ブログ投稿とは異なります。サイト訪問者に対して自分のことを説明する自己紹介ページを作成するのが一般的です。たとえば以下のようなものになります。 \n\n<blockquote>はじめまして。昼間はバイク便のメッセンジャーとして働いていますが、俳優志望でもあります。これは僕のブログです。ロサンゼルスに住み、ジャックという名前のかわいい犬を飼っています。好きなものはピニャコラーダ (通り雨に濡れるのも) 。</blockquote>\n\nまたは、このようなものでもよいでしょう。\n\n<blockquote>XYZ 小道具株式会社は1971年の創立以来、高品質の小道具を皆様にご提供させていただいています。ゴッサム・シティに所在する当社では2,000名以上の社員が働いており、様々な形で地域のコミュニティへ貢献しています。</blockquote>\n\n新しく WordPress ユーザーになった方は、<a href=\"http://brdr.local/wordpress/wp-admin/\">ダッシュボード</a>へ行ってこのページを削除し、独自のコンテンツを含む新しいページを作成してください。それでは、お楽しみください !','サンプルページ','','publish','open','open','','sample-page','','','2015-02-03 04:53:57','2015-02-03 04:53:57','',0,'http://brdr.local/?page_id=2',0,'page','',0);
...
INSERT INTO `wp_users` VALUES (1,'admin','$P$BR1EzXlrZ/xK3fkqQBQMz1uv0lOaat0','admin','vagrant@example.com','','2015-02-03 04:53:57','',0,'admin');
...
-- Dump completed on 2015-02-03 15:02:59
