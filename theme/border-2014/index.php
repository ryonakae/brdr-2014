...
<div class="l-content" id="js-pjaxArea" data-pageClass="<?php echo $pageClass; ?>">
  ...
  <section class="mainvisual" id="js-mainvisual">
    <figure class="mainvisual-image is-hidden" id="js-mainvisual-image">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/main.jpg" alt="" width="2048" height="1200">
    </figure>
          ...
          <article class="box box-playgrounds">
            <figure class="box-image">
              <a href="https://dribbble.com/ryo_dg" target="_blank">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/playground_dribbble.svg" alt="Dribbble" width="190" height="190">
              </a>
            </figure>
          ...
          <article class="box box-playgrounds">
            <figure class="box-image">
              <a href="https://jypg.net/ryo_dg" target="_blank">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/playground_jaypeg.svg" alt="JAYPEG" width="190" height="190">
              </a>
            </figure>
          ...
          <article class="box box-playgrounds">
            <figure class="box-image">
              <a href="https://github.com/ryonakae" target="_blank">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/playground_github.svg" alt="GitHub" width="190" height="190">
              </a>
            </figure>
          ...
          <article class="box box-information">
            <figure class="box-image">
              <a href="<?php the_permalink(); ?>">
                ...
                <?php else: ?>
                  <img class="noimage" src="<?php echo get_template_directory_uri(); ?>/assets/img/noimg_small.jpg" alt="noimage" width="180" height="180">
                <?php endif; ?>
              </a>
            </figure>
